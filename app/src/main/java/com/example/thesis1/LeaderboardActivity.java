...
public class LeaderboardActivity extends AppCompatActivity {
    ...
    /*private void getClickedUserTasks(){
        //this method will probably be in the clicked user activity

        //needs to call database to get logged tasks for this user
        //takes the username and logged tasks and sends those in an intent to the next screen
        DatabaseReference userRef = database.getReference("userDatabase/users/"+clickedUser.getUsername()+"/loggedTasks");
        userRef.addListenerForSingleValueEvent(new ValueEventListener() {
            @Override
            public void onDataChange(DataSnapshot secondSnapshot) {
                ...
                clickedUser.setLoggedTasks(lti);
    ...
    private void moveToUserDetailsScreen(User clickedUser){
        //get basic class setup and xml ready for clicked user details screen
        //make intent holding clicked user and their tasks
        //switch to that screen
        //needs all of the intent stuff even back from the home screen
       ...
       Intent intent= new Intent(this, LeaderboardClickedUserActivity.class);
        ...
        //clickedUserActivity will be able to use the username to call database for task list
